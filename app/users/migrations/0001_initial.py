    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documentIdUser', models.CharField(max_length=10, primary_key=True, serialize=False, unique=True, validators=[django.core.validators.RegexValidator(message='Numero incorrecto', regex='^\\+?1?\\d{7,10}$')], verbose_name='ID')),
                ...
                ('emailUser', models.EmailField(blank=True, max_length=70, unique=True)),
                ...
                ('passwordUser', models.CharField(default=[models.CharField(max_length=10, primary_key=True, serialize=False, unique=True, validators=[django.core.validators.RegexValidator(message='Numero incorrecto', regex='^\\+?1?\\d{7,10}$')], verbose_name='ID')], max_length=200)),
