...
urlpatterns = [
    ...
    path('educationalinstitution/create/', EducationalInstitutionCreate.as_view()),
    path('educationalinstitution/<pk>/', EducationalInstitutionDetail.as_view()),
    path('educationalinstitution/update/<pk>/', EducationalInstitutionUpdate.as_view()),
    path('educationalinstitution/inactivate/<pk>/', EducationalInstitutionInactivate.as_view()),
